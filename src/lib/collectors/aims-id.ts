...
// Distance Races, aims-worldrunning.org) para Indonesia. AIMS no es un
...
// carrera. (La federación local, PB PASI, tiene web propia pero su
// calendario de "Events" —powered by The Events Calendar de WordPress—
// está vacío/sin usar: se probó su API pública wp-json/tribe/events/v1
// y devuelve total:0, así que no sirve como fuente.)
//
...
// por país (/countries/114.html para Indonesia; el ID de país se
...
// organizadores tienen oficina en otra ciudad, ej. Jakarta). La
// distancia se infiere del propio nombre de la carrera ("Marathon",
// "Half Marathon" o un número final tipo "10"/"21"), sin inventar
// datos que la página no trae.
//
// Ver también los collectors hermanos aims-vn.ts, aims-th.ts y
// aims-sg.ts (misma fuente, mismo parser, distinto país).

const ID_PAIS_AIMS = "114";
const URL_PAIS = `https://aims-worldrunning.org/countries/${ID_PAIS_AIMS}.html`;
const PAIS = "Indonesia";
const CODIGO_PAIS = "ID";
const FUENTE_TIPO = "aims_id";
...
export async function correrCollectorAimsId() {
