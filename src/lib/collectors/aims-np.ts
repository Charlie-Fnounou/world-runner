...
// Distance Races, aims-worldrunning.org) para Nepal. AIMS no es un
...
// por país (/countries/148.html para Nepal; el ID de país se obtuvo
...
// sede real de la carrera (Katmandú, Pokhara, Nepalgunj...), pero no
// siempre. La distancia se infiere del propio nombre de la carrera
// ("Marathon", "Half Marathon" o un número final tipo "10"/"25"), sin
// inventar datos que la página no trae.
//
// Ver también los collectors hermanos aims-th.ts, aims-vn.ts, aims-my.ts,
// aims-lk.ts y aims-bd.ts (misma fuente, mismo parser, distinto país).

const ID_PAIS_AIMS = "148";
const URL_PAIS = `https://aims-worldrunning.org/countries/${ID_PAIS_AIMS}.html`;
const PAIS = "Nepal";
const CODIGO_PAIS = "NP";
const FUENTE_TIPO = "aims_np";
...
export async function correrCollectorAimsNp() {
