...
// Distance Races, aims-worldrunning.org) para Tailandia. AIMS no es un
...
// por país (/countries/90.html para Tailandia; el ID de país se obtuvo
...
// único dato geográfico que trae la página) — muchas agencias
// organizadoras tailandesas tienen oficina en Bangkok aunque la carrera
// sea en otra provincia (ej. "Laguna Phuket Marathon" queda con ciudad
// "Bangkok"), así que es un dato aproximado, no la sede exacta. La
// distancia se infiere del propio nombre de la carrera ("Marathon",
// "Half Marathon" o un número final tipo "10"/"21"/"42"), sin inventar
// datos que la página no trae.
//
// Ver también los collectors hermanos aims-vn.ts, aims-id.ts y
// aims-sg.ts (misma fuente, mismo parser, distinto país).

const ID_PAIS_AIMS = "90";
const URL_PAIS = `https://aims-worldrunning.org/countries/${ID_PAIS_AIMS}.html`;
const PAIS = "Tailandia";
const CODIGO_PAIS = "TH";
const FUENTE_TIPO = "aims_th";
...
export async function correrCollectorAimsTh() {
