...
// Distance Races, aims-worldrunning.org) para Singapur. AIMS no es un
...
// carrera. (Singapore Athletics, la federación local, tiene su web
// hecha como SPA en React sin datos en el HTML servido —id="root"
// vacío—, así que no se puede scrapear sin un navegador headless.)
//
...
// por país (/countries/82.html para Singapur; el ID de país se obtuvo
// una sola vez navegando /directory.html) en vez de tocar el
// calendario (/calendar.html) o las tarjetas .ics de /events/, que sí
// están bloqueadas.
//
// Singapur solo tiene una carrera miembro de AIMS (el maratón
// nacional), así que este collector trae poco volumen — se documenta
// igual como fuente primaria válida en vez de recurrir a un agregador
// comercial tipo JustRunLah o RunSociety.
//
// Ver también los collectors hermanos aims-vn.ts, aims-th.ts y
// aims-id.ts (misma fuente, mismo parser, distinto país).

const ID_PAIS_AIMS = "82";
const URL_PAIS = `https://aims-worldrunning.org/countries/${ID_PAIS_AIMS}.html`;
const PAIS = "Singapur";
const CODIGO_PAIS = "SG";
const FUENTE_TIPO = "aims_sg";
...
export async function correrCollectorAimsSg() {
