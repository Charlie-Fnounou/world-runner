...
// Distance Races, aims-worldrunning.org) para Malasia. AIMS no es un
...
// por país (/countries/61.html para Malasia; el ID de país se obtuvo
...
//
// Ver también los collectors hermanos aims-th.ts, aims-vn.ts, aims-id.ts
// y aims-sg.ts (misma fuente, mismo parser, distinto país).

const ID_PAIS_AIMS = "61";
const URL_PAIS = `https://aims-worldrunning.org/countries/${ID_PAIS_AIMS}.html`;
const PAIS = "Malasia";
const CODIGO_PAIS = "MY";
const FUENTE_TIPO = "aims_my";
...
export async function correrCollectorAimsMy() {
