...
const PAISES: Record<string, { nombre: string; continente: Continente }> = {
  ...
  BM: { nombre: "Bermudas", continente: "AMERICA_CENTRAL" },
  ...
  BA: { nombre: "Bosnia y Herzegovina", continente: "EUROPA" },
  ...
  SA: { nombre: "Arabia Saudita", continente: "ASIA" },
  IN: { nombre: "India", continente: "ASIA" },
  KR: { nombre: "Corea del Sur", continente: "ASIA" },
  TW: { nombre: "Taiwán", continente: "ASIA" },
  ...
  BI: { nombre: "Burundi", continente: "AFRICA" },
  GN: { nombre: "Guinea", continente: "AFRICA" },
};
...
const CENTROIDE_POR_PAIS: Record<string, { lat: number; lng: number }> = {
  ...
  BI: { lat: -3.3822, lng: 29.3644 },
  BM: { lat: 32.2949, lng: -64.7823 },
